...
def generate_launch_description():
    ...
    slam_params = PathJoinSubstitution([ktl_share, "config", "slam", "go2_hesai_slam_toolbox.yaml"])
    rviz_config = PathJoinSubstitution([slam_share, "config", "slam_toolbox_default.rviz"])
